...
//                callSid = callHandle
                logEvents("", arrayOf("Incoming", from, to, CallDirection.INCOMING.label, "${callInvite.customParameters}"))
                logEvents("", arrayOf("Ringing", from, to, CallDirection.INCOMING.label,"${callInvite.customParameters}"))
            }
