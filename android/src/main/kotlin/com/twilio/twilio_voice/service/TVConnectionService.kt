...
class TVConnectionService : ConnectionService() {
    ...
    private fun <T: TVCallConnection> applyParameters(connection: T, params: TVParameters) {
        ...
        val name = if(connection.callDirection == CallDirection.OUTGOING) params.to else params.customParameters["firstname"].toString()+" "+params.customParameters["lastname"].toString()
